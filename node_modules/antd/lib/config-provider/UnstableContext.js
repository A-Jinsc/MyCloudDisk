...
const defaultReactRender = (node, container) => {
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    process.env.NODE_ENV !== "production" ? (0, _warning.default)(majorVersion < 19 || !!ReactDOM.createRoot, 'compatible', 'antd v5 support React is 16 ~ 18. see https://u.ant.design/v5-for-19 for compatible.') : void 0;
  }
