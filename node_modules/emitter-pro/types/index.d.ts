...
type EventListener<F extends Listener = Listener> = {
    raw: F;
    wrap: F;
    context: object | null;
};
 ...
 *  .off('foo');
 */
declare class EmitterPro<F extends Listener = Listener> {
    private handlers;
    constructor();
    /**
     * 获取全部事件名称。
     ...
     */
    rawListeners(eventName: EventName): F[];
    /**
     ...
     */
    listeners(eventName: EventName): F[];
    /**
     * 判断事件名称对应的监听方法是否存在。
     *
     * @param eventName 事件名称
     ...
     */
    hasListener(eventName: EventName, listener: F): boolean;
    private _on;
    /**
     ...
     * // bar
     */
    prependListener(eventName: EventName, listener: F, context?: EventListener['context']): this;
    /**
     ...
     * // 42
     */
    on(eventName: EventName, listener: F, context?: EventListener['context']): this;
    private _wrapOnce;
    /**
     * 仅触发一次的监听方法。使用方法同 `on` 。
     *
     ...
     * // bar
     */
    once(eventName: EventName, listener: F, context?: EventListener['context']): this;
    /**
     ...
     * // bar
     */
    prependOnceListener(eventName: EventName, listener: F, context?: EventListener['context']): this;
    /**
     ...
     */
    off(eventName: EventName, listener?: F): this;
    /**
     * 取消全部事件名称的监听方法。
     *
     * @returns 事件触发器实例。
     ...
     * // 25
     */
    emit(eventName: EventName, ...args: Parameters<F>): boolean;
}
