...
var SliderButton = React.forwardRef(function (_a, ref) {
    var _b;
    var className = _a.className, disabled = _a.disabled, active = _a.active, success = _a.success, error = _a.error, verify = _a.verify, restProps = tslib.__rest(_a, ["className", "disabled", "active", "success", "error", "verify"]);
...
var Jigsaw = function (_a) {
    ...
    if (status === exports.Status.LoadFailed || !bgUrl || !puzzleUrl) {
        return (React.createElement("div", { className: "".concat(prefixCls, "-load-failed"), style: bgSize }, loadFailedIcon));
    }
    var isStop = status === exports.Status.Verify || status === exports.Status.Error || status === exports.Status.Success; // 是否停止滑动
...
var SliderCaptcha = function (_a) {
    ...
    var _q = rcHooks.useSafeState(exports.Status.Default), status = _q[0], setStatus = _q[1];
