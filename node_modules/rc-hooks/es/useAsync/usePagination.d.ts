 ...
 */
declare function usePagination<D = any, R extends PaginationAsyncReturn<D> = any>(asyncFn: (...args: PaginationParams) => Promise<R>, options?: PaginationOptions<R>): {
    data: R | undefined;
    run: (param1: {
        [key: string]: any;
        current: number;
    ...
    tableProps: {
        ...
        onChange: (pagination: {
            current?: number;
            pageSize?: number;
        } & Record<string, any>, filters: any, sorter: any, extra: any) => void;
        pagination: {
            total: number;
            current: number;
            pageSize: number;
